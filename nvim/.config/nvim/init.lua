...
-- Disable legacy providers to improve startup time and silence warnings
...
-- Split window keymaps to match tmux
...
-- Delete to blackhole register (keep clipboard)
vim.keymap.set('n', '<leader>d', '"_d', { desc = '[D]elete (Void)' })
